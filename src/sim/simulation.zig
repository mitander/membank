//! Deterministic simulation harness for CortexDB testing.
//!
//! Provides a framework for running the entire CortexDB system
...
/// A simulated node in the CortexDB cluster.
